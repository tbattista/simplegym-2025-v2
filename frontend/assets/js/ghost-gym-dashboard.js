 ...
 * Enhanced with better visual design, statistics, and action buttons
 */
function renderProgramsView() {
    ...
    // Enhanced program cards with better statistics and actions
 ...
 * Enhanced with better visual design, preview on hover, and action buttons
 */
function renderWorkoutsView() {
    ...
    // Enhanced workout cards with better statistics and hover preview
    workoutsGrid.innerHTML = filteredWorkouts.map(workout => {
