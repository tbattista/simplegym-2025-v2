...
@app.get("/api/v3/users/me/favorites")
...
@app.post("/api/v3/users/me/favorites")
...
@app.delete("/api/v3/users/me/favorites/{exercise_id}")
...
@app.post("/api/v3/users/me/favorites/check")
